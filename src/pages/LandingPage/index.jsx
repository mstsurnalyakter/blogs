                  ...
                  <div className="flex flex-col items-center justify-start w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      ...
                      <Button
                        ...
                        className="mt-5 text-white-A700  gap-[19px] sm:px-5 tracking-[0.12px] font-bold min-w-[255px] sm:min-w-full"
                      >
                        Continue Reading
                      </Button>
                    </div>
                    ...
                    <div className="flex flex-col items-start justify-start w-full">
                      ...
                      <div className="flex flex-row justify-start mt-5">
                        <Button
                          ...
                          className="w-full text-white-A700  gap-[19px] sm:px-5 tracking-[0.12px] font-bold"
                        >
                          Continue Reading
                        </Button>
                      </div>
